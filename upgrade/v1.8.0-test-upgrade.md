...
## 1.5. download and update v1.8.0 bundle

We will be placing v1.6.0 switcheod/switcheocli in the genesis directory and v1.8.0 switcheod/switcheocli in upgrades directory. Cosmovisor will switch to the right binary during the right block height.
