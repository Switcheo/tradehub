...
```bash
curl -L https://github.com/Switcheo/tradehub/releases/download/v1.4.0/install-testnet.tar.gz | tar -xz
```

### Mainnet Release

```bash
curl -L https://github.com/Switcheo/tradehub/releases/download/v1.4.0/install-mainnet.tar.gz | tar -xz
```
